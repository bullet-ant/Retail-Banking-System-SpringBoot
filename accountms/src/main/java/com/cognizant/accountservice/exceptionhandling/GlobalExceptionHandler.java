...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<AccountErrorResponse> handleAccessDeniedException(AccessDeniedException ex) {
		AccountErrorResponse response = new AccountErrorResponse(LocalDateTime.now(), HttpStatus.UNAUTHORIZED,
	...
	public ResponseEntity<AccountErrorResponse> handleAccountNotFoundException(AccountNotFoundException ae) {
		...
		AccountErrorResponse response = new AccountErrorResponse(LocalDateTime.now(), HttpStatus.NOT_FOUND,
				ae.getMessage(), "Account Not Found");
	...
	public ResponseEntity<AccountErrorResponse> minBalance(MinimumBalanceException exception, WebRequest request) {
	...
	public ResponseEntity<AccountErrorResponse> handleFeignException(FeignException ex) {
		AccountErrorResponse response = new AccountErrorResponse(LocalDateTime.now(), HttpStatus.INTERNAL_SERVER_ERROR,
				ex.getMessage(), "Server Down Try Later...");
